...
const formEditProduct = $("formEditProduct"); /* Encierro en una variable el nombre del ID del formulario */
const elements = formEditProduct.elements; /* Declaro en otra variable el uso de la funcion "elements" del objeto formEditProducts */
